...
%	\maketitle
	\frontmatter*[roman]
	\includepdf[pages=1-3,]{附件/封面与声明_mask}
	\includepdf{附件/田欣洋 新疆大学2023届本科毕业论文（设计）任务书_mask}
	\setcounter{page}{2}
	\pagestyle{Xju}
	\begin{cnabstract}
	{\zihao{-4}\rmfamily
...
\end{enabstract}
	...
	\input{绪论.tex}
	\input{试验方法与设备.tex}
%	\input{TC4钛合金的热处理实验.tex}
	\input{TC4合金固溶时效处理.tex}
	\input{TC4合金固溶时效处理最佳处理工艺分析.tex}
%	\input{TC4钛合金的力学性能实验与组织表征.tex}
